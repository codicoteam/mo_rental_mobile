...
class _CreateReservationScreenState extends State<CreateReservationScreen> {
  ...
  String? _selectedBranchId = '6750f1e0c1a2b34de0abcd01'; // Default branch
            ...
            content: Column(
              ...
              children: [
                ...
                if (response.data != null) ...[
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Total Amount: \$${response.data!.totalAmount.toStringAsFixed(2)}',
                    style: TextStyle(
                      fontSize: 18,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isSubmitting
                        ...
                        : Text(
                            hasVehicle ? 'Confirm & Book Now' : 'Select a Vehicle First',
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                            ),
