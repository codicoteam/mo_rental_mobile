...
class CustomerSidebarWidget extends StatefulWidget {
  final Widget child;
  final bool initiallyOpen;

  const CustomerSidebarWidget({
    super.key,
    required this.child,
  ...
  @override
  State<CustomerSidebarWidget> createState() => _SidebarWidgetState();
}

class _SidebarWidgetState extends State<CustomerSidebarWidget>
